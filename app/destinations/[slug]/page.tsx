...
export default async function DestinationPage({
  ...
  return (
    <>
      ...
      {/* JSON-LD Structured Data for TouristAttraction (Destination) */}
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "description": destination.description,
          "url": `https://easyourtour.com/destinations/${destination.slug}`,
          "image": destination.image.startsWith('/')
            ? `https://easyourtour.com${destination.image}`
            : destination.image,
          "address": {
            "@type": "PostalAddress",
          ...
          "servesCuisine": [
            "Indian cuisine",
            ...(destination.country === "India" ? ["Local regional specialties"] : [])
          ],
          "review": {
            "@type": "Review",
            "reviewRating": {
