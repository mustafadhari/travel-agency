...
export const metadata = {
  title: "International Destinations | EasYourTour",
  description: "Explore international destinations available at EasYourTour",
}

export default function InternationalDestinationsPage() {
  const list = DESTINATIONS.filter((d) => d.category === "international")

  return (
    <main className="pt-28 pb-16">
      <div className="container mx-auto px-4">
        <div className="mb-6 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-2">International Destinations</h1>
          <p className="text-muted-foreground">Browse our curated international destinations</p>
        </div>
