    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
      <div>
        ...
        <div className="space-y-4">
          <p>
            Founded in 2024, EasYourTour began with a simple mission: to create extraordinary travel services that
          ...
          <p>
            ...
            gap in the market for truly personalized, high-end travel services. Frustrated by the one-size-fits-all
          ...
          <p>
            ...
            services spanning all seven continents. What hasn't changed is our commitment to excellence, attention to
      ...
      <div className="relative h-[400px] rounded-lg overflow-hidden">
        <Image src="/placeholder.svg?height=800&width=600" alt="EasYourTour team" fill className="object-cover" />
      </div>
    </div>
  )
}
